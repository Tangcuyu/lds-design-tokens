...
var _styleDictionary = {
    ...
    "color": {
      "brand": {
        "primary": {
          "value": "#1DA1F2",
          "type": "color",
          "filePath": "src/brands/brand#2/color.json",
          "isSource": true,
          "original": {
            "value": "#1DA1F2",
            "type": "color"
  ...
  "avatar": {
    "size": {
      "xxsm": {
        "value": "36px",
        "filePath": "src/globals/avatar/index.json",
        "isSource": true,
        "original": {
          "value": "36px"
        },
        "name": "LDS_AVATAR_SIZE_XXSM",
        "attributes": {},
        "path": [
          "avatar",
          "size",
    ...
    "border_radius": {
      "circle": {
        ...
        "name": "LDS_AVATAR_BORDER_RADIUS_CIRCLE",
        "attributes": {},
        "path": [
          "avatar",
          "border_radius",
      ...
      "squared": {
        ...
        "name": "LDS_AVATAR_BORDER_RADIUS_SQUARED",
        "attributes": {},
        "path": [
          "avatar",
          "border_radius",
    ...
    "monogram": {
      "color_default": {
        ...
        "name": "LDS_AVATAR_MONOGRAM_COLOR_DEFAULT",
        "attributes": {},
        "path": [
          "avatar",
          "monogram",
      ...
      "color_variant_1": {
        ...
        "name": "LDS_AVATAR_MONOGRAM_COLOR_VARIANT_1",
        "attributes": {},
        "path": [
          "avatar",
          "monogram",
      ...
      "color_variant_2": {
        ...
        "name": "LDS_AVATAR_MONOGRAM_COLOR_VARIANT_2",
        "attributes": {},
        "path": [
          "avatar",
          "monogram",
      ...
      "color_variant_3": {
        ...
        "name": "LDS_AVATAR_MONOGRAM_COLOR_VARIANT_3",
        "attributes": {},
        "path": [
          "avatar",
          "monogram",
      ...
      "color_variant_4": {
        ...
        "name": "LDS_AVATAR_MONOGRAM_COLOR_VARIANT_4",
        "attributes": {},
        "path": [
          "avatar",
          "monogram",
      ...
      "color_variant_5": {
        ...
        "name": "LDS_AVATAR_MONOGRAM_COLOR_VARIANT_5",
        "attributes": {},
        "path": [
          "avatar",
          "monogram",
      ...
      "color_variant_6": {
        ...
        "name": "LDS_AVATAR_MONOGRAM_COLOR_VARIANT_6",
        "attributes": {},
        "path": [
          "avatar",
          "monogram",
      ...
      "color_variant_7": {
        ...
        "name": "LDS_AVATAR_MONOGRAM_COLOR_VARIANT_7",
        "attributes": {},
        "path": [
          "avatar",
          "monogram",
      ...
      "color_variant_8": {
        ...
        "name": "LDS_AVATAR_MONOGRAM_COLOR_VARIANT_8",
        "attributes": {},
        "path": [
          "avatar",
          "monogram",
      ...
      "color_variant_9": {
        ...
        "name": "LDS_AVATAR_MONOGRAM_COLOR_VARIANT_9",
        "attributes": {},
        "path": [
          "avatar",
          "monogram",
  ...
  "button": {
    "border": {
      "radius": {
        "value": "10px",
        "filePath": "src/globals/button/index.json",
        "isSource": true,
        "original": {
          "value": "{base.border.radius.value}"
        },
        "name": "LDS_BUTTON_BORDER_RADIUS",
        "attributes": {},
        "path": [
          "button",
          "border",
  ...
  "icon": {
    "size": {
      "xsm": {
        ...
        "filePath": "src/globals/icon/index.json",
        "isSource": true,
        "original": {
          "value": "10px",
          "documentation": {
  ...
  "input": {
    "placeholder": {
      "value": "#949494",
      "filePath": "src/globals/input/index.json",
      "isSource": true,
      "original": {
        "value": "{color.gray_40.value}"
      },
      "name": "LDS_INPUT_PLACEHOLDER",
      "attributes": {},
      "path": [
        "input",
        "placeholder"
  ...
  "login": {
    "size": {
      "md": {
        "value": "65px",
        "filePath": "src/globals/login/index.json",
        "isSource": true,
        "original": {
          "value": "65px"
        },
        "name": "LDS_LOGIN_SIZE_MD",
        "attributes": {},
        "path": [
          "login",
          "size",
